...
from scr.models.family_models import Family, User, Purchase, pwd_context
from scr.models.safe_family_models import SafeFamily, SafeUser, SafePurchase
...
async def prepare_family_response(family: Family) -> SafeFamily:
    ...
    return SafeFamily(
        ...
        created_at=family.id.generation_time.strftime("%d.%m.%Y в %H:%M"),
